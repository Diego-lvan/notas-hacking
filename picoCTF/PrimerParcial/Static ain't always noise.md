...
```
	diego@diego-Laptop:~/Desktop/IS/seguridad/pico$ ./ltdis.sh 
...
Bye!
diego@diego-Laptop:~/Desktop/IS/seguridad/pico$ ./ltdis.sh static 
Attempting disassembly of static ...
Disassembly successful! Available at: static.ltdis.x86_64.txt
Ripping strings from binary with file offsets...
Any strings found in static have been written to static.ltdis.strings.txt with file offset
diego@diego-Laptop:~/Desktop/IS/seguridad/pico$ cat static.ltdis.strings.txt 
   ...
   1969 .bss
   196e .comment
diego@diego-Laptop:~/Desktop/IS/seguridad/pico$ cat static.ltdis.strings.txt  | grep pico
   1020 picoCTF{d15a5m_t34s3r_1e6a7731}

```

## Notas adicionales
use grep para buscar en un archivo
## Referencias
